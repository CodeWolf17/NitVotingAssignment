...
<body>
	...
	<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
						...
						<?php
							$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'President'") or die(mysqli_errno());
							while($fetch = $query->fetch_array())
						{
						?>
                           <div id = "position">
							<img src = "media/<?php echo $fetch['img']?>" style ="border-radius:6px;" height = "150px" width = "150px" class = "img">
				...
				<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
						...
						<?php
							$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Vice President for Internal Affairs'") or die(mysqli_errno());
							while($fetch = $query->fetch_array()){
						?>
		<div id = "position">
			<img class = "image-rounded" src = "media/<?php echo $fetch['img']?>"style ="border-radius:6px;" height = "150px" width = "150px">
		<center><button type="button" class="btn btn-primary btn-xs" style = "border-radius:60px;margin-top:4px;"><?php echo $fetch['firstname']." ".$fetch['lastname']?></button></center>
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Vice President for External Affairs'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Secretary'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Auditor'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	 ...
	 <div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Treasurer'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'PIO'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Business Manager'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Sgt. @ Arms'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Muse'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $db->query("SELECT * FROM `candidate` WHERE `position` = 'Escort'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
