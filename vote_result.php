		  ...
		  <div class = "alert alert-info">
			...
			<?php
				if(!$_SESSION['pres_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[pres_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			</div>
			...
			<?php
				if(!$_SESSION['vpinternal_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[vpinternal_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			</div>
			...
			<?php
				if(!$_SESSION['vpexternal_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[vpexternal_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['secretary_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[secretary_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['auditor_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[auditor_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['treasurer_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[treasurer_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['pio_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[pio_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			</div>
			...
			<?php
				if(!$_SESSION['busman_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[busman_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['sgtarm_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[sgtarm_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['muse_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[muse_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<?php
				if(!$_SESSION['escort_id'])
					...
					{
						$fetch = $db->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[escort_id]'")->fetch_array();
						echo $fetch['firstname']." ".$fetch['lastname']." "."<img src = 'media/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
