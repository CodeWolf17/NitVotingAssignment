...
<br>
		...
		require '../dbconnect.php';
			$query = $db->query("SELECT * FROM candidate WHERE position = 'President'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
			require '../dbconnect.php';
			$query = $db->query("SELECT * FROM candidate WHERE position = 'Vice President for Internal Affairs'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Vice President for External Affairs'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Secretary'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Auditor'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Treasurer'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'PIO'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Business Manager'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Sgt. @ Arms'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Muse'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require '../dbconnect.php';
		$query = $db->query("SELECT * FROM candidate WHERE position = 'Escort'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $db->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
